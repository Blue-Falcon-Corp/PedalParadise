        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Order_Table_PaymentMethods_PaymentMethodPaymentID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RepairID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClientID = table.Column<int>(type: "int", nullable: false),
                    BikeDetails = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairRequests", x => x.RepairID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_Order_Table_OrderID",
                        column: x => x.OrderID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefundRequests_Order_Table_OrderID",
                        column: x => x.OrderID,
                        principalTable: "Order_Table",
                        principalColumn: "OrderID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_Table_PaymentMethodPaymentID",
                table: "Order_Table",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairRequests_AssignedEmployeeID",
